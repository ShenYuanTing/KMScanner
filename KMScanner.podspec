...
Pod::Spec.new do |s|
  s.name             = 'KMScanner'
  s.version          = '0.1.0'
  s.summary          = 'A short description of KMScanner.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/shenhao/KMScanner'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'shenhao' => 'shenhao@mfhcd.com' }
  s.source           = { :git => 'https://github.com/shenhao/KMScanner.git', :tag => s.version.to_s }
